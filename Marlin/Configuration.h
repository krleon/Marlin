...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.55
    #define DEFAULT_Ki   1.56
    #define DEFAULT_Kd  81.35
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 197.13
  #define DEFAULT_bedKi 37.84
  #define DEFAULT_bedKd 684.65
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 398.7, 98.9 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -4.5, -2.92 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_HEIGHT      1.0        // (mm) Z height of nozzle at leveling points
